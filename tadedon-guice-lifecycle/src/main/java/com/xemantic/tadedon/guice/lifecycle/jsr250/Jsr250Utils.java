...
public class Jsr250Utils {
	...
	private Jsr250Utils() { /* util class, non-instantiable */ }
	...
	private static String handleException(Class<? extends Annotation> jsr250Annotation, Method method, Exception e) {
		throw new RuntimeException("Error while invoking @" + jsr250Annotation.getSimpleName() + " method: " + method, e);
	}
